...
class SoraContentScreen extends StatelessWidget {
  static const String routeName='SoraContent ';
  const SoraContentScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text(QuranData.quranNames[index],style: Theme.of(context).primaryTextTheme.headline2,),
            Divider(
            ...
            Expanded(child: SingleChildScrollView(
              child: FutureBuilder<String?>(
                future: ContentController.getQuranContant(index),
